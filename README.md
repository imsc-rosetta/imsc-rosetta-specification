...
### Copyright Notice
Copyright © 2023 W3C®. This software or document includes material copied from or derived from w3c/imsc: TTML Profiles for Internet Media Subtitles and Captions (IMSC) (github.com)
...
The pre-existing copyright notice of the original author, or if it doesn't exist, a notice (hypertext is preferred, but a textual representation is permitted) of the form: "Copyright © [$date-of-document] World Wide Web Consortium. https://www.w3.org/Consortium/Legal/2023/doc-license"
